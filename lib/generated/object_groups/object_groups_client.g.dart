...
class _ObjectGroupsClient implements ObjectGroupsClient {
  _ObjectGroupsClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<ObjectGroupArray> listObjectGroups({
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ObjectGroupArray>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/object-groups',
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late ObjectGroupArray _value;
    try {
      _value = ObjectGroupArray.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<ObjectGroupSingle> getObjectGroup({
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ObjectGroupSingle>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/object-groups/${id}',
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late ObjectGroupSingle _value;
    try {
      _value = ObjectGroupSingle.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<void> deleteObjectGroup({required String id, String? xTraceId}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{r'X-Trace-Id': xTraceId};
