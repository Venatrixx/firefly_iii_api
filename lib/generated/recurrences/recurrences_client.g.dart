...
class _RecurrencesClient implements RecurrencesClient {
  _RecurrencesClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<RecurrenceSingle> storeRecurrence({
    ...
    final _options = _setStreamType<RecurrenceSingle>(
      Options(
            method: 'POST',
            headers: _headers,
            extra: _extra,
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late RecurrenceSingle _value;
    try {
      _value = RecurrenceSingle.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<void> deleteRecurrence({required String id, String? xTraceId}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{r'X-Trace-Id': xTraceId};
  ...
  @override
  Future<TransactionArray> triggerRecurrenceRecurrence({
    required String id,
