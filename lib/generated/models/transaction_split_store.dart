...
part 'transaction_split_store.g.dart';
...
class TransactionSplitStore {
  ...
  factory TransactionSplitStore.fromJson(Map<String, Object?> json) => _$TransactionSplitStoreFromJson(json);
  ...
  Map<String, Object?> toJson() => _$TransactionSplitStoreToJson(this);
}
