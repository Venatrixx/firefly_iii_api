...
part of 'attachments_client.dart';
...
class _AttachmentsClient implements AttachmentsClient {
  _AttachmentsClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<AttachmentSingle> storeAttachment({
    ...
    final _options = _setStreamType<AttachmentSingle>(
      Options(
            method: 'POST',
            headers: _headers,
            extra: _extra,
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late AttachmentSingle _value;
    try {
      _value = AttachmentSingle.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<void> deleteAttachment({required String id, String? xTraceId}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{r'X-Trace-Id': xTraceId};
