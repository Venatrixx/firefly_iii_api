...
class _PreferencesClient implements PreferencesClient {
  _PreferencesClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<PreferenceArray> listPreference({
    ...
    final _options = _setStreamType<PreferenceArray>(
    ...
    late PreferenceArray _value;
    try {
      _value = PreferenceArray.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<PreferenceSingle> storePreference({
    ...
    final _options = _setStreamType<PreferenceSingle>(
      Options(
            method: 'POST',
            headers: _headers,
            extra: _extra,
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late PreferenceSingle _value;
    try {
      _value = PreferenceSingle.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
