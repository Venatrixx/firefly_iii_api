...
part of 'piggy_banks_client.dart';
...
class _PiggyBanksClient implements PiggyBanksClient {
  _PiggyBanksClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<PiggyBankEventArray> listEventByPiggyBank({
    ...
    final _options = _setStreamType<PiggyBankEventArray>(
    ...
    late PiggyBankEventArray _value;
    try {
      _value = PiggyBankEventArray.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<PiggyBankArray> listPiggyBank({
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<PiggyBankArray>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/piggy-banks',
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late PiggyBankArray _value;
    try {
      _value = PiggyBankArray.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<PiggyBankSingle> storePiggyBank({
    ...
    final _options = _setStreamType<PiggyBankSingle>(
      Options(
            method: 'POST',
            headers: _headers,
            extra: _extra,
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late PiggyBankSingle _value;
    try {
      _value = PiggyBankSingle.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<void> deletePiggyBank({required String id, String? xTraceId}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{r'X-Trace-Id': xTraceId};
