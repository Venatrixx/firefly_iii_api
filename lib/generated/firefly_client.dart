...
import 'currency_exchange_rates/currency_exchange_rates_client.dart';
...
import 'user_groups/user_groups_client.dart';
...
///
class FireflyClient {
  FireflyClient(Dio dio, {String? baseUrl}) : _dio = dio, _baseUrl = baseUrl;

  final Dio _dio;
  final String? _baseUrl;

  static String get version => 'v6.5.5';
  ...
  CurrencyExchangeRatesClient? _currencyExchangeRates;
  LinksClient? _links;
  ...
  CurrencyExchangeRatesClient get currencyExchangeRates =>
      _currencyExchangeRates ??= CurrencyExchangeRatesClient(
        _dio,
        baseUrl: _baseUrl,
      );
  ...
  UserGroupsClient get userGroups =>
      _userGroups ??= UserGroupsClient(_dio, baseUrl: _baseUrl);
