...
part of 'currency_exchange_rates_client.dart';
...
class _CurrencyExchangeRatesClient implements CurrencyExchangeRatesClient {
  _CurrencyExchangeRatesClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<CurrencyExchangeRateArray> listCurrencyExchangeRates({
    ...
    final _options = _setStreamType<CurrencyExchangeRateArray>(
    ...
    late CurrencyExchangeRateArray _value;
    try {
      _value = CurrencyExchangeRateArray.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<CurrencyExchangeRateSingle> storeCurrencyExchangeRate({
    ...
    final _options = _setStreamType<CurrencyExchangeRateSingle>(
      Options(
            method: 'POST',
            headers: _headers,
            extra: _extra,
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late CurrencyExchangeRateSingle _value;
    try {
      _value = CurrencyExchangeRateSingle.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
