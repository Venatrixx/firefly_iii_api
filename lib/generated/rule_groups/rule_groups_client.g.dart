...
part of 'rule_groups_client.dart';
...
class _RuleGroupsClient implements RuleGroupsClient {
  _RuleGroupsClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<TransactionArray> testRuleGroup({
    ...
    final queryParameters = <String, dynamic>{
      ...
      r'triggered_limit': triggeredLimit,
      r'accounts[]': object67,
    };
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{r'X-Trace-Id': xTraceId};
  ...
  Future<RuleGroupArray> listRuleGroup({
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<RuleGroupArray>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/rule-groups',
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late RuleGroupArray _value;
    try {
      _value = RuleGroupArray.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<RuleGroupSingle> storeRuleGroup({
    ...
    final _options = _setStreamType<RuleGroupSingle>(
      Options(
            method: 'POST',
            headers: _headers,
            extra: _extra,
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late RuleGroupSingle _value;
    try {
      _value = RuleGroupSingle.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<void> deleteRuleGroup({required String id, String? xTraceId}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{r'X-Trace-Id': xTraceId};
