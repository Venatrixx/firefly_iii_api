...
class _CurrenciesClient implements CurrenciesClient {
  _CurrenciesClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<AccountArray> listAccountByCurrency({
    ...
    final _options = _setStreamType<AccountArray>(
    ...
    late AccountArray _value;
    try {
      _value = AccountArray.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<AvailableBudgetArray> listAvailableBudgetByCurrency({
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AvailableBudgetArray>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late AvailableBudgetArray _value;
    try {
      _value = AvailableBudgetArray.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<RecurrenceArray> listRecurrenceByCurrency({
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<RecurrenceArray>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late RecurrenceArray _value;
    try {
      _value = RecurrenceArray.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<CurrencyArray> listCurrency({
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<CurrencyArray>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/currencies',
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late CurrencyArray _value;
    try {
      _value = CurrencyArray.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<CurrencySingle> storeCurrency({
    ...
    final _options = _setStreamType<CurrencySingle>(
      Options(
            method: 'POST',
            headers: _headers,
            extra: _extra,
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late CurrencySingle _value;
    try {
      _value = CurrencySingle.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<CurrencySingle> primaryCurrency({
    required String code,
    String? xTraceId,
  }) async {
    final _extra = <String, dynamic>{};
  ...
  @override
  Future<void> deleteCurrency({required String code, String? xTraceId}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{r'X-Trace-Id': xTraceId};
  ...
  @override
  Future<CurrencySingle> getPrimaryCurrency({String? xTraceId}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{r'X-Trace-Id': xTraceId};
