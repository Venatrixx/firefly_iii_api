...
class _RulesClient implements RulesClient {
  _RulesClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<RuleArray> listRule({String? xTraceId, int? limit, int? page}) async {
    final _extra = <String, dynamic>{};
  ...
  Future<RuleSingle> storeRule({
    ...
    final _options = _setStreamType<RuleSingle>(
      Options(
            method: 'POST',
            headers: _headers,
            extra: _extra,
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late RuleSingle _value;
    try {
      _value = RuleSingle.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<RuleSingle> getRule({required String id, String? xTraceId}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{r'X-Trace-Id': xTraceId};
  ...
  @override
  Future<void> deleteRule({required String id, String? xTraceId}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{r'X-Trace-Id': xTraceId};
